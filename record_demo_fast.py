#!/usr/bin/env python3
"""
Fast Demo Recording - Uses existing Streamlit instance
Run your Streamlit app first: streamlit run app.py
...
async def record_demo():
    """Record demo using existing Streamlit instance"""
    
    print("🎬 Fast Demo Recording (using existing Streamlit)")
    print("=" * 60)
    print()
    ...
    async with async_playwright() as p:
        ...
        # Navigate to app
        print("📍 Scene 1: Navigate to app (0-3s)")
        await page.goto('http://localhost:8501', wait_until='networkidle')
        await asyncio.sleep(2)
        
        # Upload file
        print("📤 Scene 2: Upload file (3-5s)")
        ...
        # Wait for analysis (should be ~5 seconds as you mentioned)
        print("⚙️  Scene 3: Analysis in progress (5-12s)")
        ...
        print("📊 Scene 4: View results (12-15s)")
        await page.evaluate("window.scrollTo({ top: 300, behavior: 'smooth' })")
        await asyncio.sleep(2)
        
        # Click on risk item
        print("🔍 Scene 5: Examine risk details (15-18s)")
        ...
        print("📋 Scene 6: Review details (18-21s)")
        await page.evaluate("window.scrollTo({ top: 500, behavior: 'smooth' })")
        await asyncio.sleep(2)
        
        # Final frame
        print("✨ Scene 7: Final frame (21-22s)")
        await asyncio.sleep(1)
...
def convert_to_formats(video_path):
    ...
    print()
    print("Total recording time: ~22 seconds")


async def main():
    print()
    print("=" * 60)
    print("  LUMEN FAST DEMO RECORDER")
    print("  Uses existing Streamlit instance")
    print("=" * 60)
    print()
